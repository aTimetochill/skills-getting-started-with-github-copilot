...
activities = {
    ...
    "Soccer Team": {
        "description": "Team drills, strategy, and competitive matches",
    ...
    "Drama Workshop": {
        "description": "Learn acting, improvisation, and stage performance",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 20,
        "participants": ["olivia@mergington.edu", "michael@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice persuasive speaking and structured argumentation",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["daniel@mergington.edu", "emma@mergington.edu"]    
    }
}
